...
var file_msg_proto_rawDesc = []byte{
	...
	0x74, 0x74, 0x52, 0x03, 0x70, 0x74, 0x74, 0x22, 0xdf, 0x04, 0x0a, 0x04, 0x45, 0x6c, 0x65, 0x6d,
	...
	,
	...
	0x74, 0x2a, 0x2e, 0x0a, 0x08, 0x53, 0x79, 0x6e, 0x63, 0x46, 0x6c, 0x61, 0x67, 0x12, 0x09, 0x0a,
...
var file_msg_proto_msgTypes = make([]protoimpl.MessageInfo, 50)
var file_msg_proto_goTypes = []interface{}{
	...
	(*Face)(nil),                  // 33: Face
	(*LightAppElem)(nil),          // 34: LightAppElem
	(*CustomFace)(nil),            // 35: CustomFace
	(*ContentHead)(nil),           // 36: ContentHead
	(*MessageHead)(nil),           // 37: MessageHead
	(*GroupInfo)(nil),             // 38: GroupInfo
	(*DiscussInfo)(nil),           // 39: DiscussInfo
	(*MutilTransHead)(nil),        // 40: MutilTransHead
	(*C2CTempMessageHead)(nil),    // 41: C2CTempMessageHead
	(*InstCtrl)(nil),              // 42: InstCtrl
	(*InstInfo)(nil),              // 43: InstInfo
	(*ExtGroupKeyInfo)(nil),       // 44: ExtGroupKeyInfo
	(*SyncCookie)(nil),            // 45: SyncCookie
	(*TransMsgInfo)(nil),          // 46: TransMsgInfo
	(*GeneralFlags)(nil),          // 47: GeneralFlags
	(*PbMultiMsgItem)(nil),        // 48: PbMultiMsgItem
	(*PbMultiMsgNew)(nil),         // 49: PbMultiMsgNew
	(*PbMultiMsgTransmit)(nil),    // 50: PbMultiMsgTransmit
}
var file_msg_proto_depIdxs = []int32{
	0,  // 0: GetMessageRequest.syncFlag:type_name -> SyncFlag
	8,  // 1: SendMessageRequest.routingHead:type_name -> RoutingHead
	36, // 2: SendMessageRequest.contentHead:type_name -> ContentHead
	...
	37, // 17: Message.head:type_name -> MessageHead
	36, // 18: Message.content:type_name -> ContentHead
	...
	35, // 29: Elem.customFace:type_name -> CustomFace
	...
	47, // 36: Elem.generalFlags:type_name -> GeneralFlags
	32, // 37: Elem.srcMsg:type_name -> SourceMsg
	34, // 38: Elem.lightApp:type_name -> LightAppElem
	19, // 39: SourceMsg.elems:type_name -> Elem
	41, // 40: MessageHead.c2cTmpMsgHead:type_name -> C2CTempMessageHead
	38, // 41: MessageHead.groupInfo:type_name -> GroupInfo
	39, // 42: MessageHead.discussInfo:type_name -> DiscussInfo
	40, // 43: MessageHead.mutiltransHead:type_name -> MutilTransHead
	42, // 44: MessageHead.msgInstCtrl:type_name -> InstCtrl
	44, // 45: MessageHead.extGroupKeyInfo:type_name -> ExtGroupKeyInfo
	43, // 46: InstCtrl.msgSendToInst:type_name -> InstInfo
	43, // 47: InstCtrl.msgExcludeInst:type_name -> InstInfo
	43, // 48: InstCtrl.msgFromInst:type_name -> InstInfo
	44, // 49: TransMsgInfo.extGroupKeyInfo:type_name -> ExtGroupKeyInfo
	16, // 50: PbMultiMsgNew.msg:type_name -> Message
	16, // 51: PbMultiMsgTransmit.msg:type_name -> Message
	48, // 52: PbMultiMsgTransmit.pbItemList:type_name -> PbMultiMsgItem
