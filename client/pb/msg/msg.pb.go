...
var file_msg_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0b, 0x32, 0x04, 0x2e, 0x50, 0x74, 0x74, 0x52, 0x03, 0x70, 0x74, 0x74, 0x22, 0xbe,
...
var file_msg_proto_goTypes = []interface{}{
	...
	(*RichMsg)(nil),               // 22: RichMsg
	(*CustomElem)(nil),            // 23: CustomElem
	(*Text)(nil),                  // 24: Text
	(*Attr)(nil),                  // 25: Attr
	(*Ptt)(nil),                   // 26: Ptt
	(*OnlineImage)(nil),           // 27: OnlineImage
	(*NotOnlineImage)(nil),        // 28: NotOnlineImage
	(*NotOnlineFile)(nil),         // 29: NotOnlineFile
	(*TransElem)(nil),             // 30: TransElem
	(*ExtraInfo)(nil),             // 31: ExtraInfo
	(*GroupFile)(nil),             // 32: GroupFile
	(*AnonymousGroupMessage)(nil), // 33: AnonymousGroupMessage
	(*VideoFile)(nil),             // 34: VideoFile
	(*SourceMsg)(nil),             // 35: SourceMsg
	(*Face)(nil),                  // 36: Face
	(*LightAppElem)(nil),          // 37: LightAppElem
	(*CustomFace)(nil),            // 38: CustomFace
	(*ContentHead)(nil),           // 39: ContentHead
	(*MessageHead)(nil),           // 40: MessageHead
	(*GroupInfo)(nil),             // 41: GroupInfo
	(*DiscussInfo)(nil),           // 42: DiscussInfo
	(*MutilTransHead)(nil),        // 43: MutilTransHead
	(*C2CTempMessageHead)(nil),    // 44: C2CTempMessageHead
	(*InstCtrl)(nil),              // 45: InstCtrl
	(*InstInfo)(nil),              // 46: InstInfo
	(*ExtGroupKeyInfo)(nil),       // 47: ExtGroupKeyInfo
	(*SyncCookie)(nil),            // 48: SyncCookie
	(*TransMsgInfo)(nil),          // 49: TransMsgInfo
	(*GeneralFlags)(nil),          // 50: GeneralFlags
	(*PbMultiMsgItem)(nil),        // 51: PbMultiMsgItem
	(*PbMultiMsgNew)(nil),         // 52: PbMultiMsgNew
	(*PbMultiMsgTransmit)(nil),    // 53: PbMultiMsgTransmit
}
var file_msg_proto_depIdxs = []int32{
	0,  // 0: GetMessageRequest.syncFlag:type_name -> SyncFlag
	9,  // 1: SendMessageRequest.routingHead:type_name -> RoutingHead
	39, // 2: SendMessageRequest.contentHead:type_name -> ContentHead
	...
	40, // 17: Message.head:type_name -> MessageHead
	39, // 18: Message.content:type_name -> ContentHead
	18, // 19: Message.body:type_name -> MessageBody
	19, // 20: MessageBody.richText:type_name -> RichText
	25, // 21: RichText.attr:type_name -> Attr
	20, // 22: RichText.elems:type_name -> Elem
	29, // 23: RichText.notOnlineFile:type_name -> NotOnlineFile
	26, // 24: RichText.ptt:type_name -> Ptt
	24, // 25: Elem.text:type_name -> Text
	36, // 26: Elem.face:type_name -> Face
	27, // 27: Elem.onlineImage:type_name -> OnlineImage
	28, // 28: Elem.notOnlineImage:type_name -> NotOnlineImage
	30, // 29: Elem.transElemInfo:type_name -> TransElem
	38, // 30: Elem.customFace:type_name -> CustomFace
	22, // 31: Elem.richMsg:type_name -> RichMsg
	32, // 32: Elem.groupFile:type_name -> GroupFile
	31, // 33: Elem.extraInfo:type_name -> ExtraInfo
	34, // 34: Elem.videoFile:type_name -> VideoFile
	33, // 35: Elem.anonGroupMsg:type_name -> AnonymousGroupMessage
	23, // 36: Elem.customElem:type_name -> CustomElem
	50, // 37: Elem.generalFlags:type_name -> GeneralFlags
	35, // 38: Elem.srcMsg:type_name -> SourceMsg
	37, // 39: Elem.lightApp:type_name -> LightAppElem
	21, // 40: Elem.commonElem:type_name -> CommonElem
	20, // 41: SourceMsg.elems:type_name -> Elem
	44, // 42: MessageHead.c2cTmpMsgHead:type_name -> C2CTempMessageHead
	41, // 43: MessageHead.groupInfo:type_name -> GroupInfo
	42, // 44: MessageHead.discussInfo:type_name -> DiscussInfo
	43, // 45: MessageHead.mutiltransHead:type_name -> MutilTransHead
	45, // 46: MessageHead.msgInstCtrl:type_name -> InstCtrl
	47, // 47: MessageHead.extGroupKeyInfo:type_name -> ExtGroupKeyInfo
	46, // 48: InstCtrl.msgSendToInst:type_name -> InstInfo
	46, // 49: InstCtrl.msgExcludeInst:type_name -> InstInfo
	46, // 50: InstCtrl.msgFromInst:type_name -> InstInfo
	47, // 51: TransMsgInfo.extGroupKeyInfo:type_name -> ExtGroupKeyInfo
	17, // 52: PbMultiMsgNew.msg:type_name -> Message
	17, // 53: PbMultiMsgTransmit.msg:type_name -> Message
	51, // 54: PbMultiMsgTransmit.pbItemList:type_name -> PbMultiMsgItem
