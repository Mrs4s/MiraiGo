...
var file_pb_channel_unknown_proto_rawDesc = []byte{
	...
	0x6f, 0x6c, 0x65, 0x52, 0x05, 0x72, 0x6f, 0x6c, 0x65, 0x73, 0x22, 0x50, 0x0a, 0x0c, 0x47, 0x75,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x6a, 0x6f, 0x69, 0x6e, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x55,
	0x0a, 0x09, 0x47, 0x75, 0x69, 0x6c, 0x64, 0x52, 0x6f, 0x6c, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x72,
	...
	0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x61, 0x72, 0x67, 0x62, 0x43,
	0x6f, 0x6c, 0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x61, 0x72, 0x67, 0x62,
	0x43, 0x6f, 0x6c, 0x6f, 0x72, 0x22, 0xf5, 0x02, 0x0a, 0x09, 0x47, 0x75, 0x69, 0x6c, 0x64, 0x4d,
...
var file_pb_channel_unknown_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_pb_channel_unknown_proto_goTypes = []interface{}{
	...
	(*GuildMetaRsp)(nil),             // 7: channel.GuildMetaRsp
	(*ChannelListRsp)(nil),           // 8: channel.ChannelListRsp
	(*GuildAdminInfo)(nil),           // 9: channel.GuildAdminInfo
	(*GuildMemberInfo)(nil),          // 10: channel.GuildMemberInfo
	(*GuildUserProfile)(nil),         // 11: channel.GuildUserProfile
	(*GuildRole)(nil),                // 12: channel.GuildRole
	(*GuildMeta)(nil),                // 13: channel.GuildMeta
	(*GuildChannelInfo)(nil),         // 14: channel.GuildChannelInfo
	(*GuildChannelSlowModeInfo)(nil), // 15: channel.GuildChannelSlowModeInfo
	(*GuildChannelTopMsgInfo)(nil),   // 16: channel.GuildChannelTopMsgInfo
}
var file_pb_channel_unknown_proto_depIdxs = []int32{
	10, // 0: channel.ChannelOidb0xf5bRsp.bots:type_name -> channel.GuildMemberInfo
	10, // 1: channel.ChannelOidb0xf5bRsp.members:type_name -> channel.GuildMemberInfo
	9,  // 2: channel.ChannelOidb0xf5bRsp.adminInfo:type_name -> channel.GuildAdminInfo
	11, // 3: channel.ChannelOidb0xf88Rsp.profile:type_name -> channel.GuildUserProfile
	11, // 4: channel.ChannelOidb0xfc9Rsp.profile:type_name -> channel.GuildUserProfile
	7,  // 5: channel.ChannelOidb0xf57Rsp.rsp:type_name -> channel.GuildMetaRsp
	14, // 6: channel.ChannelOidb0xf55Rsp.info:type_name -> channel.GuildChannelInfo
	8,  // 7: channel.ChannelOidb0xf5dRsp.rsp:type_name -> channel.ChannelListRsp
	12, // 8: channel.ChannelOidb0x1019Rsp.roles:type_name -> channel.GuildRole
	13, // 9: channel.GuildMetaRsp.meta:type_name -> channel.GuildMeta
	14, // 10: channel.ChannelListRsp.channels:type_name -> channel.GuildChannelInfo
	10, // 11: channel.GuildAdminInfo.admins:type_name -> channel.GuildMemberInfo
	16, // 12: channel.GuildChannelInfo.topMsg:type_name -> channel.GuildChannelTopMsgInfo
	15, // 13: channel.GuildChannelInfo.slowModeInfos:type_name -> channel.GuildChannelSlowModeInfo
